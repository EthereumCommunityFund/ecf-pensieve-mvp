...
export const alphaItemConfig: Partial<Record<IItemKey, IItemConfig<IItemKey>>> =
  {
    ...
    d_app_storage_stack: {
      ...
      subCategory: IItemSubCategoryEnum.BasicProfile,
      isEssential: false,
      label: 'D-app storage stack (Nov, 2022)',
    ...
    d_app_account_management_stack: {
      ...
      subCategory: IItemSubCategoryEnum.BasicProfile,
      isEssential: false,
      label: 'D-app Account Management(i.e ID) stack (Nov, 2022)',
    ...
    d_app_logic_program_stack: {
      ...
      subCategory: IItemSubCategoryEnum.BasicProfile,
      isEssential: false,
      label: 'D-app logic/program stack (Nov, 2022)\\',
