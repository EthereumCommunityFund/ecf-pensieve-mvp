...
The technical dependencies, integrations, and building blocks that form the foundation of this project. This includes protocols, libraries, APIs, and other technical components that the project relies on or integrates with to deliver its functionality.`,
  ...
  audit_report: {
    ...
    label: 'Audit Report',
    description:
      'Reference the audit report detailing security or financial findings.',
    shortDescription: 'Link or details about the audit report.',
    longDescription:
      "Provide details about the project's audit report, including auditors involved, scope, and security or compliance findings.",
  ...
  previous_funding_rounds: {
    ...
    description: 'Link to documentation covering past funding rounds.',
    shortDescription: 'Reference previous funding rounds.',
    longDescription:
      "Provide a link to documentation or announcements covering the project's previous funding rounds, including amounts and participants.",
  ...
  vault_multi_sig_holder_addresses_step2: {
    ...
    subCategory: IItemSubCategoryEnum.Finances,
    isEssential: false,
    label: 'Vault Multi-sig Holder Addresses',
    description:
      'Link to information about the treasury multi-sig holders or disclosure of signer addresses.',
    shortDescription: 'Reference for treasury multi-sig holders.',
    longDescription:
      'Provide a reference that discloses the addresses or identities of the treasury multi-sig signers to support transparency.',
    ...
    legitimacy: [],
    validationSchema:
      itemValidationSchemas.vault_multi_sig_holder_addresses_step2,
  },
