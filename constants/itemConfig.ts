...
The technical dependencies, integrations, and building blocks that form the foundation of this project. This includes protocols, libraries, APIs, and other technical components that the project relies on or integrates with to deliver its functionality.`,
  ...
  token_benefits: {
    ...
    longDescription:
      'Provide detailed context for Token Benefits (Finance), including how holders gain access, rewards, or other programmatic perks.',
  ...
  token_risks: {
    ...
    longDescription:
      'Provide detailed context for Token Risks, covering concentration, volatility, privileged roles, and other systemic threats.',
  ...
  token_rights: {
    ...
    longDescription:
      'Provide detailed context for Token Rights (Governance), covering how token holders can signal, vote, or manage protocol resources.',
  ...
  token_obligations: {
    ...
    longDescription:
      'Provide detailed context for Token Obligations, including staking, lockups, compliance, and community contribution expectations.',
