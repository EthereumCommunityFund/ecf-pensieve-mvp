...
// --- Icons ---
import { HeadingFiveIcon } from '@/components/base/MdEditor/tiptap-icons/heading-five-icon';
import { HeadingFourIcon } from '@/components/base/MdEditor/tiptap-icons/heading-four-icon';
import { HeadingOneIcon } from '@/components/base/MdEditor/tiptap-icons/heading-one-icon';
import { HeadingSixIcon } from '@/components/base/MdEditor/tiptap-icons/heading-six-icon';
import { HeadingThreeIcon } from '@/components/base/MdEditor/tiptap-icons/heading-three-icon';
import { HeadingTwoIcon } from '@/components/base/MdEditor/tiptap-icons/heading-two-icon';
