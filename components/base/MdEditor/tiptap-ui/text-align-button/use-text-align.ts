...
// --- Icons ---
import { AlignCenterIcon } from '@/components/base/MdEditor/tiptap-icons/align-center-icon';
import { AlignJustifyIcon } from '@/components/base/MdEditor/tiptap-icons/align-justify-icon';
import { AlignLeftIcon } from '@/components/base/MdEditor/tiptap-icons/align-left-icon';
import { AlignRightIcon } from '@/components/base/MdEditor/tiptap-icons/align-right-icon';
