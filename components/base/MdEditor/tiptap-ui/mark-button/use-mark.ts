...
// --- Icons ---
import { BoldIcon } from '@/components/base/MdEditor/tiptap-icons/bold-icon';
import { Code2Icon } from '@/components/base/MdEditor/tiptap-icons/code2-icon';
import { ItalicIcon } from '@/components/base/MdEditor/tiptap-icons/italic-icon';
import { StrikeIcon } from '@/components/base/MdEditor/tiptap-icons/strike-icon';
import { SubscriptIcon } from '@/components/base/MdEditor/tiptap-icons/subscript-icon';
import { SuperscriptIcon } from '@/components/base/MdEditor/tiptap-icons/superscript-icon';
import { UnderlineIcon } from '@/components/base/MdEditor/tiptap-icons/underline-icon';
