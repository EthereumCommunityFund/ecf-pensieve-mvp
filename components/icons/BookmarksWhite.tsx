...
interface BookmarksWhiteIconProps {
  size?: number;
  className?: string;
}

const BookmarksWhiteIcon: React.FC<BookmarksWhiteIconProps> = ({
  size = 24,
  className = '',
}) => {
  return (
    <svg
      ...
      className={className}
    >
      <g clipPath="url(#clip0_3298_6273)">
        <path
...
export default BookmarksWhiteIcon;
