...
type ProjectNameInputRef = React.ElementRef<typeof Input>;

const ProjectNameSuggestionsInput = React.forwardRef<
  ProjectNameInputRef,
  ProjectNameSuggestionsInputProps
>(
  (
    { name, value, placeholder, isInvalid, isDisabled, onChange, onBlur },
    ref,
  ) => {
    ...
    const shouldSearch =
      debouncedQuery.length >= MIN_QUERY_LENGTH && !isDisabled;
...
ProjectNameSuggestionsInput.displayName = 'ProjectNameSuggestionsInput';
