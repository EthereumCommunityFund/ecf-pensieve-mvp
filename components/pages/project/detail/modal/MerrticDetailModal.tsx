    ...
    >
      <ModalContent className="m-0 h-[400px] w-[600px] rounded-[10px] border border-[rgba(0,0,0,0.1)] bg-white p-0 shadow-none">
        ...
        <div className="flex items-center justify-between border-b border-[rgba(0,0,0,0.1)] p-5">
          <span className="font-open-sans text-[16px] font-semibold leading-[1.36] text-black opacity-80">
            {title}
          </span>
          <Button
            isIconOnly
        ...
        <div className="flex flex-1 flex-col gap-[10px] overflow-y-auto p-[10px]">
          ...
          <div className="flex justify-start">
            <div className="rounded-[20px] bg-[#F5F5F5] px-2 py-1">
              <span className="font-inter text-[13px] font-medium leading-[1.46] text-[#333333]">
                {metricName}
              </span>
            </div>
          </div>
          ...
          <div className="flex-1">
            <p className="font-inter whitespace-pre-line text-[14px] font-normal leading-[1.6] text-black">
              {description}
            </p>
          </div>
        </div>
        ...
        {/* Footer */}
        <div className="flex items-center border-t border-[rgba(0,0,0,0.1)] px-[30px] py-[10px]">
          <span className="font-open-sans text-[16px] font-semibold leading-[1.36] text-black opacity-60">
            Footer
          </span>
        </div>
      </ModalContent>
