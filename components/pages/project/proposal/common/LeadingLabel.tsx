...
const ActiveLeadingLabel = ({
  ...
  return (
    <div className="flex shrink-0 items-center gap-[5px] rounded-[5px] border border-[rgba(104,204,174,0.40)] bg-[rgba(104,204,174,0.10)] px-[8px] py-[4px] text-[14px] font-[400] leading-[20px] text-[#40A486]">
      ...
      <Tooltip
        content="This is the currently most supported proposal for this pending project thus, is in the leading position"
        classNames={{
      ...
      >
        <button
          className="-m-1 cursor-pointer rounded-sm p-1 transition-opacity duration-200 hover:opacity-70 focus:outline-none focus:ring-2 focus:ring-blue-500/50"
          aria-label="Leading proposal information"
          title="This is the currently most supported proposal for this pending project thus, is in the leading position"
        >
          <svg
        ...
        >
          ...
          >
            <g opacity="0.34">
              ...
              />
              <path
                d="M9.6875 7.34375C10.119 7.34375 10.4688 6.99397 10.4688 6.5625C10.4688 6.13103 10.119 5.78125 9.6875 5.78125C9.25603 5.78125 8.90625 6.13103 8.90625 6.5625C8.90625 6.29397 9.25603 7.34375 9.6875 7.34375Z"
                fill="black"
              />
              <path
