...
const placeholderThreads: ThreadMeta[] = [
  ...
  {
    id: '14',
    title: 'Coordinated phishing DMs mimic ecosystem support staff',
    excerpt:
      'Multiple builders received identical links asking for vault approvals from fake “ecosystem relief” accounts.',
    author: 'SafetyWatch',
    ...
    totalSentimentVotes: 60,
  },
  {
    id: '15',
    title: 'Fake OTC desk impersonating matching partner',
    excerpt:
      'Alleged OTC desk uses old grant deck branding and directs donors to a multisig not owned by the team.',
    author: 'RiskOps',
    timeAgo: '1 day ago',
    replies: 12,
    votes: 104,
    ...
    sentiment: 'Provocative',
    sentimentBreakdown: [
      { key: 'recommend', percentage: 14 },
      { key: 'agree', percentage: 26 },
      { key: 'provocative', percentage: 40 },
      { key: 'disagree', percentage: 20 },
    ],
    totalSentimentVotes: 55,
  },
  {
    id: '16',
    title: 'Malicious browser extension drains contributor wallets',
    excerpt:
      'Security researchers identified a fake “gas saver” extension that injects malicious approvals into the claim flow.',
    author: 'BugHunter',
    timeAgo: '4 hours ago',
    replies: 9,
    votes: 131,
